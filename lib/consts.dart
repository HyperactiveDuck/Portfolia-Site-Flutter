...
String kExp =
    "First Year:\n-Joined the company as a Network intern, contributing to various projects and gaining valuable experience.\n-Collaborated with a team to successfully establish a cutting-edge cyber security lab for 'Ostim Technical University' within the first two months of employment.\n\nSecond Year:\n-Joined the company as a Cyber Security Intern, receiving comprehensive training in various aspects of cyber security.\n-Obtained a CyberOps certificate from Cisco, validating expertise in cyber security practices.\n-Played a crucial role in developing and documenting cyber security procedures for the company, along with two additional projects.\n-Led a team of fellow interns in the reconstruction of a collection of previously recorded lectures streamlining accessibility and enhancing the overall user experience.\n\nPromoted to Ethical Hacking Insturctor:\n-Developed and delivered engaging lectures to a diverse group of over 50 sector professionals\nincluding computer engineers, IT workers, and software developers.\n-Topics covered in the lectures included basic networking, foundations of penetration\ntesting, logging, and SOC (Security Operations Center) tools.-Provided guidance and assistance to\nstudents with their personal\ncyber security projects, fostering their growth and development.";
String kConnect =
    "Please don't hesitate to get in touch if you're interested in hiring, simply want to establish a connection, or explore the possibility of collaborating on an incredible project.";
